...
function main() {
    // Create a semaphore to wait for response from 
    // all workers
    var s = new Semaphore();
    var NUMBER_OF_WORKERS = 8;
    
    // Create a new workers from this same module.
    ...
    // Wait until we have responses from all workers,
    // but with a timeout that is barely long enough.
