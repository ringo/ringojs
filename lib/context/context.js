...
var {ServletContextHandler, ServletHolder, FilterHolder} = org.eclipse.jetty.servlet;
var {StatisticsHandler} = org.eclipse.jetty.server.handler;
var {EnumSet} = java.util;
var {DispatcherType} = javax.servlet;
...
Context.prototype.addFilter = function(path, filter, initParams) {
    ...
    this.contextHandler.addFilter(filterHolder, path, EnumSet.of(DispatcherType.REQUEST));
    return filterHolder;
};