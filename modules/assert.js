...
var comparators = (function() {
    ...
    return {
        ...
        "array": function(a1, a2) {
            ...
            if (a1.length > 0) {
                return a1.every(function(val, idx) {
                    return isStrictEqual(val, a2[idx]);
                });
            }
            return true;
        },
        ...
        "object": function(obj1, obj2) {
            ...
            var obj1props = getOwnKeys(obj1);
            var obj2props = getOwnKeys(obj2);
            return isStrictEqual(obj1props, obj2props) && obj1props.every(function(propName, idx) {
                return isStrictEqual(obj1[propName], obj2[propName]);
            });
        }
    };
})();
