...
/**
 * @fileoverview Fields and methods of the helma.http module.
 * <br /><br />
 ...
 * @returns A newly created helma.http.Client instance
 * @constructor
 */
function Client() {
    var self = this;
    ...
    var setTimeout = function(type, value) {
        ...
        if (parseFloat(v, 10) >= 1.5) {
            ...
            app.logger.warn("helma.http.Client: Timeouts can only be set with Java Runtime version >= 1.5");
        }
        return true;
    }
